...
This skill contains **9 CRITICAL RULES** (in SKILL.md). When an agent violates any rule:
...
| 2 | Ask Q1-Q6 first | Browser started before ask_user Q1 | Test ABORT | Re-ask questions; restart |
...
Agent attempts action
  │
  ├─ Action violates CRITICAL RULE 1-9?
